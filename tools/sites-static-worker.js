...
function applyProductSlot(html, requestedSlot) {
  ...
  return html
    .replace(
      'data-active-slot="' + DEFAULT_PRODUCT_SLOT + '"',
      'data-active-slot="' + requestedSlot + '"',
    )
    .replace(
      'class="product-cell is-active" data-product-slot="' +
    ...
    .replace(
      ...
      'class="product-cell" data-product-slot="' +
        DEFAULT_PRODUCT_SLOT +
        '"',
    );
}
